...
#line 253 "parser.y"
        ...
        appendInstruction(&code, (yyvsp[-2].expr_attr).code);
        appendInstruction(&code, (yyvsp[0].expr_attr).code);
        instruction *instr = createInstruction("sub", (yyvsp[-2].expr_attr).place, (yyvsp[0].expr_attr).place, resultReg);
        appendInstruction(&code, instr);
        (yyval.expr_attr) = (typeof((yyval.expr_attr))){.type = "int", .place = resultReg, .code = code};
    }
...
#line 263 "parser.y"
        ...
        appendInstruction(&code, (yyvsp[-2].expr_attr).code);
        appendInstruction(&code, (yyvsp[0].expr_attr).code);
        instruction *instr = createInstruction("mult", (yyvsp[-2].expr_attr).place, (yyvsp[0].expr_attr).place, resultReg);
        appendInstruction(&code, instr);
        (yyval.expr_attr) = (typeof((yyval.expr_attr))){.type = "int", .place = resultReg, .code = code};
...
#line 274 "parser.y"
        ...
        appendInstruction(&code, (yyvsp[-2].expr_attr).code);
        appendInstruction(&code, (yyvsp[0].expr_attr).code);
        instruction *instr = createInstruction("div", (yyvsp[-2].expr_attr).place, (yyvsp[0].expr_attr).place, resultReg);
        appendInstruction(&code, instr);
        (yyval.expr_attr) = (typeof((yyval.expr_attr))){.type = "int", .place = resultReg, .code = code};
    }
...
#line 303 "parser.y"
        ...
        char *resultReg = createRegisterName(regNum);
        char valueStr[20];
        sprintf(valueStr, "%f", (yyvsp[0].fval));
...
#line 311 "parser.y"
        ...
        char *resultReg = createRegisterName(regNum);
        char valueStr[20];
        sprintf(valueStr, "%s", (yyvsp[0].sval));
        instruction *instr = createInstruction("loadI", valueStr, NULL, resultReg);
